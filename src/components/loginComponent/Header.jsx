...
const Header = () => {
  ...
  return (
    <div className=" fixed top-0 start-0 z-50 w-full hover:bg-black  ">
      ...
      <div className="flex flex-wrap sm:justify-between items-center p-2 justify-center">
        ...
        {user &&
          <div >
            ...
            <button className="px-2 py-1 bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500 text-white mr-4 rounded text-sm sm:font-bold " onClick={handleGPTBtn}>{GPTSearchStatus ? "Home" : "GPT Search"}</button>
